...
(function(a)
{
    ...
    l={notificationList:
        ...
        defaultCategory:"general",anchor:"body",
...
x={
    ...
    notificationIcon:'<img src="" alt="notification icon"/>',notificationBubble:'<span class="notification-bubble" title="Notifications"></span>'};
e={
...
function r(E,D){
    ...
    return w[E][D]
        ...
        if(E=="all"&&D=="all"){
            ...
            a.extend(C,w[E[B]].read,w[E[B]].unread);a.extend(F,C)
            }
        return F
        }
        else{
